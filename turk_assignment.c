...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/15 11:25:57 by ywagner           #+#    #+#             */
/*   Updated: 2025/07/15 11:25:59 by ywagner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "push_swap.h"

static void	set_target(t_list *stack_a, t_list *stack_b);
static void	set_price(t_list *stack_a, t_list *stack_b);
